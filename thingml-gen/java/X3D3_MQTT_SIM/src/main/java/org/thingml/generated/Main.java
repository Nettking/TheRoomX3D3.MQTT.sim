...
final double[] pim_temp_buffer_array = new double[15];
...
PIM_pim.initPIM_current_temp_var((double) (0));
PIM_pim.initPIM_last_temp_1_var((double) (0));
PIM_pim.initPIM_last_temp_2_var((double) (0));
PIM_pim.initPIM_last_temp_3_var((double) (0));
PIM_pim.initPIM_last_temp_4_var((double) (0));
PIM_pim.initPIM_last_temp_5_var((double) (0));
PIM_pim.initPIM_current_average_diff_var((double) (0));
PIM_pim.initPIM_warming_time_var((double) (10));
PIM_pim.initPIM_cooling_time_var((double) (10));
PIM_pim.initPIM_buffer_size_var((int) (15));
PIM_pim.initPIM_i_var((int)0);
PIM_pim.initPIM_buffer_full_var((boolean)false);
PIM_pim.initPIM_buffer_rear_var((int) (0));
PIM_pim.initPIM_buffer_front_var((int) (0));
PIM_pim.initPIM_temp_buffer_var(pim_temp_buffer_array);

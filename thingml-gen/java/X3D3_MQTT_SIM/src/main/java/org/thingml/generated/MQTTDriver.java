...
Transition h2101737463 = new Transition();
h2101737463.from(state_MQTTDriver_behaviorMQTTDriver_Idle).to(state_MQTTDriver_behaviorMQTTDriver_Idle);
h2101737463.event(temperatureType);
h2101737463.port(MQTT_port);
h2101737463.action((Event e)->{
...
Transition h1187818999 = new Transition();
h1187818999.from(state_MQTTDriver_behaviorMQTTDriver_Idle).to(state_MQTTDriver_behaviorMQTTDriver_Idle);
h1187818999.event(add_thermometerType);
h1187818999.port(require_val_port);
h1187818999.action((Event e)->{
...
Transition h618477650 = new Transition();
h618477650.from(state_MQTTDriver_behaviorMQTTDriver_Idle).to(state_MQTTDriver_behaviorMQTTDriver_Idle);
h618477650.event(add_lightsensorType);
h618477650.port(require_val_port);
h618477650.action((Event e)->{
...
Transition h1192724663 = new Transition();
h1192724663.from(state_MQTTDriver_behaviorMQTTDriver_Idle).to(state_MQTTDriver_behaviorMQTTDriver_Idle);
h1192724663.event(luminanceType);
h1192724663.port(MQTT_port);
h1192724663.action((Event e)->{
...
Transition h667927229 = new Transition();
h667927229.from(state_MQTTDriver_behaviorMQTTDriver_Idle).to(state_MQTTDriver_behaviorMQTTDriver_Idle);
h667927229.event(add_deviceType);
h667927229.port(require_val_port);
h667927229.action((Event e)->{
...
Transition h1792255177 = new Transition();
h1792255177.from(state_MQTTDriver_behaviorMQTTDriver_Idle).to(state_MQTTDriver_behaviorMQTTDriver_Idle);
h1792255177.event(SwitchOnType);
h1792255177.port(require_val_port);
h1792255177.action((Event e)->{
...
Transition h1288414322 = new Transition();
h1288414322.from(state_MQTTDriver_behaviorMQTTDriver_Idle).to(state_MQTTDriver_behaviorMQTTDriver_Idle);
h1288414322.event(SwitchOffType);
h1288414322.port(require_val_port);
h1288414322.action((Event e)->{

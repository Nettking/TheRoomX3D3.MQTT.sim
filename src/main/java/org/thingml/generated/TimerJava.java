...
Handler h1935870377 = new Handler();
h1935870377.from(state_TimerJava_SoftTimer_default);
h1935870377.event(timer_startType);
h1935870377.guard((Event e)->{
...
h1935870377.port(timer_port);
h1935870377.action((Event e)->{
final Timer_startMessageType.Timer_startMessage timer_start = (Timer_startMessageType.Timer_startMessage) e;

...
Transition h219812012 = new Transition();
h219812012.from(state_MQTTDriver_behaviorMQTTDriver_Idle).to(state_MQTTDriver_behaviorMQTTDriver_Idle);
h219812012.event(temperatureType);
h219812012.port(MQTT_port);
h219812012.action((Event e)->{
...
h1871580398.from(state_MQTTDriver_behaviorMQTTDriver_Idle).to(state_MQTTDriver_behaviorMQTTDriver_Idle);
h1871580398.event(add_thermometerType);
h1871580398.port(require_val_port);
h1871580398.action((Event e)->{
...
Transition h1832657711 = new Transition();
h1832657711.from(state_MQTTDriver_behaviorMQTTDriver_Idle).to(state_MQTTDriver_behaviorMQTTDriver_Idle);
h1832657711.event(add_lightsensorType);
h1832657711.port(require_val_port);
h1832657711.action((Event e)->{
...
Transition h704387627 = new Transition();
h704387627.from(state_MQTTDriver_behaviorMQTTDriver_Idle).to(state_MQTTDriver_behaviorMQTTDriver_Idle);
h704387627.event(luminanceType);
h704387627.port(MQTT_port);
h704387627.action((Event e)->{
...
h584157293.from(state_MQTTDriver_behaviorMQTTDriver_Idle).to(state_MQTTDriver_behaviorMQTTDriver_Idle);
h584157293.event(add_deviceType);
h584157293.port(require_val_port);
...
Transition h426070939 = new Transition();
h426070939.from(state_MQTTDriver_behaviorMQTTDriver_Idle).to(state_MQTTDriver_behaviorMQTTDriver_Idle);
h426070939.event(SwitchOnType);
h426070939.port(require_val_port);
h426070939.action((Event e)->{
...
Transition h844872102 = new Transition();
h844872102.from(state_MQTTDriver_behaviorMQTTDriver_Idle).to(state_MQTTDriver_behaviorMQTTDriver_Idle);
h844872102.event(SwitchOffType);
h844872102.port(require_val_port);
h844872102.action((Event e)->{

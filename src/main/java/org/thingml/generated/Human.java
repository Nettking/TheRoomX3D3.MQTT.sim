...
h105393903.from(state_Human_HumanBehavior_Idle).to(state_Human_HumanBehavior_Idle);
h105393903.event(add_motionsensorType);
h105393903.port(TTYin_lum_mot_port);
h105393903.action((Event e)->{
...
Transition h1540031691 = new Transition();
h1540031691.from(state_Human_HumanBehavior_Idle).to(state_Human_HumanBehavior_Idle);
h1540031691.event(add_lightsensorType);
h1540031691.port(TTYin_lum_mot_port);
h1540031691.action((Event e)->{
...
Transition h737085888 = new Transition();
h737085888.from(state_Human_HumanBehavior_Idle).to(state_Human_HumanBehavior_Idle);
h737085888.event(SwitchOnType);
h737085888.port(TTYin_temp_port);
h737085888.action((Event e)->{
...
Transition h773518491 = new Transition();
h773518491.from(state_Human_HumanBehavior_Idle).to(state_Human_HumanBehavior_Idle);
h773518491.event(SwitchOffType);
h773518491.port(TTYin_temp_port);
h773518491.action((Event e)->{
...
Transition h270734602 = new Transition();
h270734602.from(state_Human_HumanBehavior_Idle).to(state_Human_HumanBehavior_Idle);
h270734602.event(set_temperatureType);
h270734602.port(TTYin_temp_port);
h270734602.action((Event e)->{
...
Transition h1330411679 = new Transition();
h1330411679.from(state_Human_HumanBehavior_Idle).to(state_Human_HumanBehavior_Idle);
h1330411679.event(set_deltaType);
h1330411679.port(TTYin_temp_port);
h1330411679.action((Event e)->{
...
Transition h224192895 = new Transition();
h224192895.from(state_Human_HumanBehavior_Idle).to(state_Human_HumanBehavior_Idle);
h224192895.event(fetch_tempType);
h224192895.port(TTYin_temp_port);
h224192895.action((Event e)->{
sendFetch_temp_via_send_cmd_temp();
});

Transition h1745701482 = new Transition();
h1745701482.from(state_Human_HumanBehavior_Idle).to(state_Human_HumanBehavior_Idle);
h1745701482.event(temperatureType);
h1745701482.port(TTYout_port);
h1745701482.action((Event e)->{
...
Transition h885991756 = new Transition();
h885991756.from(state_Human_HumanBehavior_Idle).to(state_Human_HumanBehavior_Idle);
h885991756.event(luminanceType);
h885991756.port(TTYout_port);
h885991756.action((Event e)->{
...
Transition h81505591 = new Transition();
h81505591.from(state_Human_HumanBehavior_Idle).to(state_Human_HumanBehavior_Idle);
h81505591.event(motionType);
h81505591.port(TTYout_port);
h81505591.action((Event e)->{
final MotionMessageType.MotionMessage motion = (MotionMessageType.MotionMessage) e;
sendMotion_via_get_values((int) (motion.id));
});

Transition h1090057640 = new Transition();
h1090057640.from(state_Human_HumanBehavior_Idle).to(state_Human_HumanBehavior_Idle);
h1090057640.event(nomotionType);
h1090057640.port(TTYout_port);
h1090057640.action((Event e)->{
...
Transition h987950392 = new Transition();
h987950392.from(state_Human_HumanBehavior_Idle).to(state_Human_HumanBehavior_Idle);
h987950392.event(promptType);
h987950392.port(TTYout_port);
h987950392.action((Event e)->{
